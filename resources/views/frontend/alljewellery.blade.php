                    ...
                    <div class="lg:bg-primary lg:flex">
                        ...
                        <div class="flex w-full flex-wrap">
                            ...
                            <div class="flex space-x-4">
                                <button type="submit"
                                    class="px-4 py-2 text-white bg-[#601042] border border-[#601042] hover:bg-white hover:text-[#601042] transition-colors duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#601042] focus:ring-offset-2">
                                    Apply
                                </button>
                                <a href="{{ route('alljewellery', ['material' => $material, 'category' => $category?->id]) }}"
                                    class="inline-flex items-center justify-center px-4 py-2 text-white bg-[#601042] border border-[#601042] hover:bg-white hover:text-[#601042] transition-colors duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#601042] focus:ring-offset-2">
                                    Clear
                                </a>
                            </div>
                        </div>
