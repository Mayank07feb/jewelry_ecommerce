...
<div class="relative w-full h-screen md:h-[40rem] overflow-hidden swiper-container">
    ...
    <div class="swiper-wrapper">
        ...
        <!-- Slide 2 -->
        <div class="swiper-slide w-full h-full flex-shrink-0 relative">
            <img src="{{ asset('asset\img\banner') }}" alt="Bridal Jewellery Collection" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex items-center justify-center">
                <div class="text-center text-white p-4 md:p-10">
        ...
        <!-- Slide 3 -->
        <div class="swiper-slide w-full h-full flex-shrink-0 relative">
            <img src="{{ asset('asset\img\banner') }}" alt="Luxury Gold Jewellery" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex items-center justify-center">
                <div class="text-center text-white p-4 md:p-10">
                    ...
                    <button class="mt-6 px-8 py-3 bg-[#601042] hover:bg-[#601042] text-white text-sm md:text-lg rounded-full transition duration-300">Browse Now</button>
                </div>
            </div>
        </div>
    </div>  
...
{{-- 
    ...
    <div class="tabs-container flex justify-center space-x-4 py-4">
        <button id="newTab" class="tab-button border-[#601042]">New Ins</button>
        <button id="bestTab" class="tab-button">Best Sellers</button>
    </div>

    <!-- NEW PRODUCTS -->
    <div id="newSlider" class="slider-container relative">
        <div class="flex transition-transform duration-300 ease-in-out" id="newSliderTrack">
            <!-- Product 1 -->
        ...
        <button id="newNextBtn" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full">
            Next
        </button>
    </div>

    <!-- BEST SELLERS -->
    <div id="bestSlider" class="slider-container relative hidden">
        <div class="flex transition-transform duration-300 ease-in-out" id="bestSliderTrack">
            <!-- Product 1 -->
            <div class="w-full md:w-1/2 lg:w-1/4 flex-shrink-0 p-2">
                <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
                    <div class="relative">
            ...
            <!-- Repeat Product Blocks -->
            <!-- Add more best seller products here -->
        </div>
        <button id="bestNextBtn" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full">
            Next
        </button>
</div> --}}
...
{{-- Category Section --}}
    <div class="w-full mx-auto ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-28 py-12" >
            <!-- Diamond Category -->
...
{{-- PROMISES --}}
<div class="hidden mx-auto bg-[#601042] w-full">
    <h1 class="text-center text-2xl md:text-3xl font-semibold text-white mb-4">Gititra Promises</h1>
    <p class="text-center text-lg text-gray-200 mb-8">Incredible rationales to shop with us!</p>
    
    <!-- Swiper Container -->
    <div class="swiper-container overflow-hidden  sm:hidden">
        <div class="swiper-wrapper">
            <!-- Slide 1 -->
            ...
            <div class="swiper-slide items-center justify-center text-center p-6 bg-[#601042] shadow-md rounded-lg">
                <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div><h2 class="text-lg font-medium text-white">GOLD EXCHANGE</h2></div>
            </div>
            <!-- Slide 7 -->
            <div class="swiper-slide items-center justify-center text-center p-6 bg-[#601042] shadow-md rounded-lg">
                <svg width="56" height="45" viewBox="0 0 56 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="
                    </svg>               
                     <div><h2 class="text-lg font-medium text-white">14 DAYS RETURNS</h2></div>
            </div>
        </div>
...
<div class="w-full bg-[#601042] mx-auto px-4 md:px-12 py-8 my-8">
    <!-- Heading -->
    <div class="text-center mb-8">
        <h1 class="text-2xl md:text-3xl font-semibold text-white">Gititra Promises</h1>
        <p class="text-lg text-gray-200">Incredible rationales to shop with us!</p>
    </div>

    <!-- Grid Section -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-8">
        <!-- Icon 1: BIS Hallmarked -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            ...
            <h1 class="text-lg font-medium text-white">BIS HALLMARKED</h1>
        </div>
        <!-- Icon 2: Lifetime Buyback -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            <div class="flex justify-center">
            <svg width="54" height="38" viewBox="0 0 54 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="path-1-inside-1_6092_46546" fill="white">
            ...
            <h1 class="text-lg font-medium text-white">LIFETIME BUYBACK</h1>
        </div>
        <!-- Icon 3: Insured Free Shipping -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            <div class="flex justify-center">
            <svg width="55" height="38" viewBox="0 0 55 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.0843 5.94531L10.8236 8.61652L10.4062 10.8425L10.8236 13.5137L12.9105 18.4109L15.8321 21.0822H17.919L20.0059 20.1918L22.0928 17.0753L23.3449 13.0685L23.7623 10.3973L23.3449 8.61652L17.0843 5.94531Z" fill="#4D2753"/>
            ...
            <h1 class="text-lg font-medium text-white">INSURED FREE SHIPPING</h1>
        </div>
        <!-- Icon 4: Purity Guarantee -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            <div class="flex justify-center">
            <svg width="32" height="45" viewBox="0 0 32 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.8279 6.81845L16.4095 6.13477L12.3074 6.81845L10.5982 8.18582L8.20526 10.5787L7.17973 12.9716L6.83789 16.0482L7.52158 19.4666L9.91447 22.2014L12.3074 23.9106L16.4095 24.9361L18.4605 24.2524L21.1953 23.2269L23.2463 21.5177L24.2719 19.1248L25.2974 17.0737V14.339L24.2719 11.6042L22.5627 8.86951L19.8279 6.81845Z" fill="#4D2753"/>
            ...
            <h1 class="text-lg font-medium text-white">PURITY GUARANTEE</h1>
        </div>
        <!-- Icon 5: Lifetime Exchange -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            <div class="flex justify-center">
            <svg width="35" height="45" viewBox="0 0 35 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.3495 39.9231C15.0076 39.9231 12.7354 39.4613 10.5962 38.5505C8.53002 37.671 6.67475 36.4121 5.08165 34.8084C3.48855 33.205 2.2376 31.3375 1.3637 29.2581C0.458794 27.1047 0 24.8178 0 22.4608C0 22.0819 0.306253 21.7737 0.682729 21.7737C1.05921 21.7737 1.36546 22.0819 1.36546 22.4608C1.36546 31.3318 8.53587 38.5488 17.3495 38.5488H22.7993V35.9795C22.7993 35.6006 23.1055 35.2924 23.482 35.2924C23.8585 35.2924 24.1647 35.6006 24.1647 35.9795V42.8355L32.9569 35.3784L24.1647 27.9215V31.5212C24.1647 31.9001 23.8585 32.2084 23.482 32.2084H17.348C16.0414 32.2082 14.7735 31.9504 13.5797 31.4421C12.4265 30.9511 11.3907 30.2484 10.5015 29.3533C10.2353 29.0853 10.2353 28.6495 10.5015 28.3815C10.6305 28.2517 10.8019 28.1802 10.9843 28.1802C11.1667 28.1802 11.3382 28.2517 11.4671 28.3815C13.0382 29.9627 15.1271 30.8339 17.3491 30.8339H22.7995V26.4437C22.7995 26.1774 22.9545 25.9328 23.1943 25.8205C23.2852 25.7779 23.3819 25.7565 23.482 25.7565C23.6429 25.7565 23.7992 25.814 23.9221 25.9183L34.4564 34.853C34.6107 34.9839 34.6992 35.1754 34.6992 35.3784C34.6992 35.5814 34.6107 35.773 34.4564 35.9038L23.9219 44.8387C23.7196 45.0103 23.4338 45.0486 23.1941 44.9363C22.9541 44.824 22.7993 44.5793 22.7993 44.3131V39.9229H17.3495V39.9231Z" fill="#F0D37A"/>
            ...
            <h1 class="text-lg font-medium text-white">LIFETIME EXCHANGE</h1>
        </div>
        <!-- Icon 6: Gold Exchange -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            <div class="flex justify-center">
            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_6092_46592)">
            ...
            <h1 class="text-lg font-medium text-white">GOLD EXCHANGE</h1>
        </div>
        <!-- Icon 7: 14 Days Returns -->
        <div class="items-center justify-center text-center p-4 bg-[#601042] shadow-md rounded-lg">
            ...
            <h1 class="text-lg font-medium text-white">14 DAYS RETURNS</h1>
        </div>
    </div>
</div>
...
<div class="px-4 pt-4 text-2xl text-center">Crafted Elegance</div> --}}
 {{-- Horizontal Line --}}
 <div class="flex items-center justify-center w-full mx-auto p-4">
    <div class="flex-grow h-px bg-[#9d6e2a]"></div>
    <div class="mx-4">
    ...
    <div id="mouse-parallax-container" class="relative w-full h-full">
      ...
      <div class="relative w-[80vw] lg:w-[55vw] h-[50vh] lg:h-[70vh] overflow-hidden">
        ...
        <div class="absolute inset-0 flex justify-center items-center w-full">
          <div class="text-white text-[60px] lg:text-[95px] md:text-[70px] sm:text-[45px] px-4 lg:px-12 font-bold uppercase text-center">
            Crafted Elegance
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col1.webp')}}" alt="Collection 1" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
            ...
            <!-- Collection 2 -->
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col2.webp')}}" alt="Collection 2" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-80 transition duration-300"></div>
            ...
            <!-- Collection 3 -->
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col3.webp')}}" alt="Collection 3" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-80 transition duration-300"></div>
            ...
            <!-- Collection 4 -->
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col4.webp')}}" alt="Collection 4" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-80 transition duration-300"></div>
            ...
            <!-- Collection 5 -->
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col5.webp')}}" alt="Collection 5" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-80 transition duration-300"></div>
            ...
            <!-- Collection 6 -->
            <div class="group relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{asset('asset\img\col6.webp')}}" alt="Collection 6" class="object-cover w-full h-full transition duration-300 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-80 transition duration-300"></div>
    ...
    <div class="flex items-center justify-center py-8 px-4 lg:px-8 bg-[#faf1e3] ">
        <div class=" p-6  max-w-3xl mx-auto">
            ...
            <p class=" text-gray-600 mb-8">
                The brand builds a family of long-term ambassadors and celebrities passionate about jewellery. Discover all PNG Jewellers brand ambassadors and celebrities who have launched campaigns and collections, wholeheartedly endorsing the brand.
            </p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-0">
            ...
            <div>
                ...
                <div id="celebrity-slider-2" class="w-full overflow-hidden mb-0 relative">
                    <div class="flex transition-transform duration-300 ease-in-out">
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s2A.webp') }}" alt="Slider 2 Image 1" class="w-full h-72 object-cover">
                        </div>
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s2-C.webp') }}" alt="Slider 2 Image 2" class="w-full h-72 object-cover">
                        </div>
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s2-C.webp') }}" alt="Slider 2 Image 3" class="w-full h-72 object-cover">
                        </div>
                    </div>
                </div>
                ...
                <div id="celebrity-slider-3" class="w-full overflow-hidden relative">
                    <div class="flex transition-transform duration-300 ease-in-out">
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s3A.webp') }}" alt="Slider 3 Image 1" class="w-full h-72 object-cover">
                        </div>
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s3B.webp') }}" alt="Slider 3 Image 2" class="w-full h-72 object-cover">
                        </div>
                        <div class="min-w-full flex-shrink-0">
                            <img src="{{ asset('asset\img\s3A.webp') }}" alt="Slider 3 Image 3" class="w-full h-72 object-cover">
                        </div>
                    </div>
                </div>
            </div>
