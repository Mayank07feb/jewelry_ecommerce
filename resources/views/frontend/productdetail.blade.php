...
<style>
    ...
    .zoomWindowContainer {
        position: absolute;
        top: 0;
        right: -350px; /* Adjust the right margin to position the zoom window */
        width: 300px;
        height: 400px;
    }
</style>
    ...
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="lg:w-1/2 grid grid-cols-2 gap-4">
            <div class="col-span-2 relative group">
                <img id="zoom_10" src="{{ asset('asset/img/new.jpg') }}" alt="Main Gold Chain Image" class="w-full rounded-lg shadow-md transition-transform duration-300 ease-in-out transform group-hover:scale-105 demo-trigger" data-zoom="{{ asset('asset/img/new.jpg') }}">
            </div>
            <div class="relative group">
                <img src="{{ asset('asset/img/new.jpg') }}" alt="Gold Chain Image" class="w-full rounded-lg shadow-md transition-transform duration-300 ease-in-out transform group-hover:scale-105 demo-trigger" data-zoom="{{ asset('asset/img/new.jpg') }}">
            </div>
            <div class="relative group">
                <img src="{{ asset('asset/img/new.jpg') }}" alt="Gold Chain Image" class="w-full rounded-lg shadow-md transition-transform duration-300 ease-in-out transform group-hover:scale-105 demo-trigger" data-zoom="{{ asset('asset/img/new.jpg') }}">
            </div>
        ...
        <div class="lg:w-1/2 lg:pl-10 space-y-6">
            ...
            <p class="text-gray-600 mb-4">Discover the epitome of sophistication and luxury with our stunning collection of gold chains. Each chain is meticulously crafted to perfection.</p>
            ...
            <div class="bg-[#f5e4f7] border border-[#e6d6e7] text-[#601042] p-3 rounded-md inline-block text-center mb-4">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <select id="metal_purity" class="mt-1 block w-full border-[#9d6e2a] rounded-md shadow-sm focus:ring-[#601042] focus:border-[#601042]">
                        <option>22KT</option>
                        <option>18KT</option>
                    </select>
                </div>
                <div>
                    ...
                    <select id="metal_type" class="mt-1 block w-full border-[#9d6e2a] rounded-md shadow-sm focus:ring-[#601042] focus:border-[#601042]">
            ...
            <div class="mt-4 mb-4">
                ...
                <div class="flex space-x-2">
                    <input type="text" id="pincode" class="border-[#9d6e2a] rounded-md shadow-sm focus:ring-[#601042] focus:border-[#601042] w-full" placeholder="Enter Pincode">
            ...
            <div class="mt-4 border border-gray-200 rounded-md">
                <button id="priceToggle" class="w-full flex justify-between items-center px-4 py-3 text-[#601042] font-semibold hover:bg-gray-100 focus:outline-none" onclick="toggleAccordion()">
                    <span>View Price Breakup</span>
                    <svg id="accordionIcon" class="w-5 h-5 transform transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
