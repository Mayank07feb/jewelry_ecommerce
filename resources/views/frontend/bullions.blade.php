                    ...
                    <div
                        ...
                        <a href="{{ route('productdetail', ['product' => $product->id]) }}">
                            <div class="overflow-hidden">
                                <img src="{{ asset('storage/'. $product->image->image) }}" alt="Rainbow Radiance Diamond Ladies Ring"
                                    class="w-full h-64 object-cover rounded-t-lg transition-transform duration-300 transform hover:scale-110">
                            </div>
                        </a>
                        @php
                            $discountedPrice = $product->variation->price - ($product->variation->price * $product->discount)/100;
                        @endphp
                        <div class="p-4 bg-gradient-to-b from-gray-50 to-white">
                            <p class="text-lg font-semibold text-gray-800">₹{{$discountedPrice}} <span
