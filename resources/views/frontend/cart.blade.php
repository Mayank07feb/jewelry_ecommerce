            ...
            <div class="lg:w-2/3 mb-8 lg:mb-0">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
                    <div class="p-4 sm:p-6">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 pb-6 border-b border-gray-200">
                            <div class="w-full sm:w-32 h-32 bg-[#f0e7da] rounded-lg overflow-hidden flex-shrink-0 shadow-md">
                                <img src="{{ asset('asset/img/gem3.png') }}" alt="Product image" class="w-full h-full object-contain">
                            </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 space-y-4 sm:space-y-0">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex items-center border border-gray-300 rounded-md">
                                            <button class="px-2 py-1 text-gray-600 hover:text-[#601042] focus:outline-none" onclick="updateQuantity(-1)">
                                                <i class="material-icons">remove</i>
                                            </button>
                                            <span id="quantity" class="px-2 py-1 border-x border-gray-300 min-w-[30px] text-center">1</span>
                                            <button class="px-2 py-1 text-gray-600 hover:text-[#601042] focus:outline-none" onclick="updateQuantity(1)">
                                                <i class="material-icons">add</i>
                                            </button>
                                        </div>
                                        <button type="button" class="text-sm bg-[#601042] hover:bg-[#740e4d] font-medium text-white transition duration-150 ease-in-out flex items-center px-2 py-1 rounded">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200 sticky top-4">
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-4">
                                <div class="flex items-center border border-gray-300 rounded-md">
                                    <input type="text" id="coupon" class="flex-grow border-none rounded-l-md p-2 focus:ring-2 focus:ring-[#601042]" placeholder="Enter coupon code">
                                    <button onclick="applyCoupon()" class="bg-[#601042] text-white px-4 py-2 rounded-r-md hover:bg-[#740e4d] transition">
                                        Apply
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="px-6 py-6 bg-gray-50">
                        <button type="submit" class="w-full bg-[#601042] border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-[#601042] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#601042] transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex items-center justify-center">
                            <i class="material-icons mr-2">shopping_bag</i>
                            Place Order
                        </button>                        
                        <p class="mt-4 text-center text-xs sm:text-sm text-gray-500">By placing your order, you agree to our <a href="#" class="font-medium text-[#9d6e2a] hover:text-[#601042]">Terms and Conditions</a>.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    const availableCoupons = [
        { code: 'SAVE500', discount: 500, description: 'Save ₹500 on your order' },
        { code: 'SAVE1000', discount: 1000, description: 'Save ₹1000 on your order' },
        { code: 'SAVE20PERCENT', discount: Math.round(subtotalAmount * 0.2), description: 'Save 20% on your order' }
    ];
