...
<div class="flex flex-col lg:flex-row lg:gap-x-8 lg:px-8 px-4 py-5">
  ...
  <div class="bg-white lg:w-2/3 border-b lg:border-0">
    <div class="hidden lg:block border-b px-4 py-5">
      <h2 class="text-lg font-light text-black relative before:absolute before:bottom-0 before:bg-black/80 leading-none before:w-8 before:h-0.5 pb-1.5">
        Shopping Cart
      </h2>
    </div>
    <div class="px-4">
      <div class="border-b border-gray-200 last:border-b-0 grid gap-x-5 py-6 items-start lg:grid-cols-[125px_1fr] grid-cols-[115px_1fr]">
        <!-- Product Image -->
        <div class="relative bg-[#F9F7F2] w-full" style="padding-top: 125%;">
          <img src="{{asset('asset/img/payal.webp')}}" alt="Product image" class="absolute inset-0 object-contain w-full h-full">
        </div>
        <!-- Product Details -->
        <div class="grid grid-cols-2 lg:gap-y-4 gap-y-2">
          <!-- Product Info -->
          <div class="col-span-2 sm:col-span-1">
            <a href="/sparkling-charm-silver-anklet-296?variantApin=BMVSDB5VSA6G" class="text-black text-sm mb-2 lg:mb-3">Sparkling Charm Silver Anklet</a>
            <div class="text-xs">
            ...
            <div class="mt-1.5">
              <a href="/sparkling-charm-silver-anklet-296?variantApin=BMVSDB5VSA6G" class="text-primary underline text-xs">Change</a>


              <div class="flex items-center space-x-2">
                <!-- Mini Bus SVG -->
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-primary">
                  <path d="M4 16V11C4 9.34315 5.34315 8 7 8H17C18.6569 8 20 9.34315 20 11V16M4 16H20M4 16L2 20H5M20 16L22 20H19M7 20H9M15 20H17" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
{{-- Wishlist Button --}}
              <div class="flex justify-between items-center lg:mt-4">
                ...
                <button type="button" class="border bg-[#8a1960c5] text-white px-4 pt-2 lg:pt-1.5 pb-1.5 hover:bg-[#7c3161fb] hover:text-white transition">
                  Move to Wishlist
                </button>
              
                <!-- Delete Section for larger screens -->
                <div class="hidden lg:flex items-center text-[11px] cursor-pointer uppercase tracking-[0.2em] lg:-mt-2">
                  <!-- SVG Icon -->
                  <svg width="13" height="17" viewBox="0 0 13 17" fill="currentColor" class="mr-2 rtl:ml-2">
                    <path d="M1.49981 16C1.09981 8.8 7.33314 6 10.4998 5.5L11 16H1.49981Z" fill="#EED2E8"></path>
                    <path d="M11.4586 16.6663H1.04285V4.68626H2.08251V15.6266H10.4189V4.68626H11.4586V16.6663ZM0 2.61011H12.5014V3.64977H0V2.61011Z" fill="black"></path>
                    <path d="M8.85436 3.6436H3.64648V0H8.85436V3.6436ZM4.68615 2.61029H7.81469V1.03967H4.68615V2.61029ZM4.16791 6.25072H5.20757V13.5411H4.16791V6.25072ZM7.29327 6.25072H8.33293V13.5411H7.29327V6.25072Z" fill="black"></path>
                  </svg>
          ...
          <div class="col-span-2 sm:col-span-1 flex flex-col items-start sm:items-end space-y-2">
            <div class="relative flex items-center text-xs text-black">
              ...
              <select class="w-16 text-center border border-gray-300 rounded-md bg-white outline-none focus:ring-2 focus:ring-purple-300">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
...
<div class="bg-white lg:w-1/3 px-6 py-6 rounded-lg shadow-md">
  ...
  <div class="mt-6">
    ...
    <div class="lg:px-8">
      ...
      <!-- Button -->
      <button class="bg-[#8a1960c5] text-white w-full lg:mb-8 min-h-[50px] py-2 px-4 rounded-md font-semibold  hover:bg-[#7c3161fb] transition duration-300">
        Place Order
      </button>
    </div>
  </div>
  ...
  <div class="flex items-center justify-center text-xs font-light mt-6 mb-4 lg:hidden">
    <svg width="12" height="15" viewBox="0 0 12 15" fill="currentColor" class="mr-2">
      <path d="M10.5 15H1.5C1.10218 15 0.720644 14.842 0.43934 14.5607C0.158035 14.2794 0 13.8978 0 13.5V8C0 7.60218 0.158035 7.22064 0.43934 6.93934C0.720644 6.65804 1.10218 6.5 1.5 6.5H10.5C10.8978 6.5 11.2794 6.65804 11.5607 6.93934C11.842 7.22064 12 7.60218 12 8V13.5C12 13.8978 11.842 14.2794 11.5607 14.5607C11.2794 14.842 10.8978 15 10.5 15ZM1.5 7.5C1.36739 7.5 1.24021 7.55268 1.14645 7.64645C1.05268 7.74021 1 7.86739 1 8V13.5C1 13.6326 1.05268 13.7598 1.14645 13.8536C1.24021 13.9473 1.36739 14 1.5 14H10.5C10.6326 14 10.7598 13.9473 10.8536 13.8536C10.9473 13.7598 11 13.6326 11 13.5V8C11 7.86739 10.9473 7.74021 10.8536 7.64645C10.7598 7.55268 10.6326 7.5 10.5 7.5H1.5Z" fill="#424242"></path>
      <path d="M10 7.5H2C1.86739 7.5 1.74021 7.44732 1.64645 7.35355C1.55268 7.25979 1.5 7.13261 1.5 7V4C1.5 2.93913 1.92143 1.92172 2.67157 1.17157C3.42172 0.421427 4.43913 0 5.5 0H6.5C7.56087 0 8.57828 0.421427 9.32843 1.17157C10.0786 1.92172 10.5 2.93913 10.5 4V7C10.5 7.13261 10.4473 7.25979 10.3536 7.35355C10.2598 7.44732 10.1326 7.5 10 7.5ZM2.5 6.5H9.5V4C9.5 3.20435 9.18393 2.44129 8.62132 1.87868C8.05871 1.31607 7.29565 1 6.5 1H5.5C4.70435 1 3.94129 1.31607 3.37868 1.87868C2.81607 2.44129 2.5 3.20435 2.5 4V6.5Z" fill="#424242"></path>
      <path d="M6 11C5.80222 11 5.60888 10.9414 5.44443 10.8315C5.27998 10.7216 5.15181 10.5654 5.07612 10.3827C5.00043 10.2 4.98063 9.99889 5.01922 9.80491C5.0578 9.61093 5.15304 9.43275 5.29289 9.29289C5.43275 9.15304 5.61093 9.0578 5.80491 9.01922C5.99889 8.98063 6.19996 9.00043 6.38268 9.07612C6.56541 9.15181 6.72159 9.27998 6.83147 9.44443C6.94135 9.60888 7 9.80222 7 10C7 10.2652 6.89464 10.5196 6.70711 10.7071C6.51957 10.8946 6.26522 11 6 11Z" fill="#424242"></path>
      <path d="M6.5 10.5H5.5V12.5H6.5V10.5Z" fill="#424242"></path>
    </svg>
    Secure Payment
  </div>

  <img src="/images/payment-gateways.webp" alt="Payment gateways" class="mx-auto mb-8 w-[265px] h-[39px] object-contain">
</div>
</div>
